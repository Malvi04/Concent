...
<div id="pcoded" class="pcoded">
                                ...
                                <!-- Page-header end -->
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>List PIC</h5>
												<a href="form-add-pic.php"><button class="btn btn-sm btn-success btn-new-tickets waves-effect waves-light m-r-15 m-b-5 m-t-5" style="float: right;"><i class="icofont icofont-user-alt-3"></i>Add PIC</button></a>
											</div>
	...
	$user = $_SESSION['nama'];	
	$Cari="select * from ticketscategory";
	$Tampil = mysqli_query($Open, $Cari);
	    while (	$hasil = mysqli_fetch_array ($Tampil)) {
			$id= stripslashes ($hasil['id']);
			$category= stripslashes ($hasil['category']);
			$personInCharge = stripslashes ($hasil['personInCharge']);
	...
	?>
                                                                    <tr>
																		...
																		<td><?=$dateUpdate?></td>
																		<td>
																		<a title="Edit" data-placement="right" class="bbtn btn-sm btn-warning btn-new-tickets waves-effect waves-light m-r-15 m-b-5 m-t-5" data-toggle="modal" href="#myModal3" onclick="set_url3('form-edit-pic.php?id=<?=$id?>');">Edit</a>
																		<a title="Del" data-placement="right" class="bbtn btn-sm btn-danger btn-new-tickets waves-effect waves-light m-r-15 m-b-5 m-t-5" data-toggle="modal" href="#myModal" onclick="set_url('ac-del-pic.php?id=<?=$id?>');">Delete</a>
																		</td>
																	</tr>
																	<?php  
		}
