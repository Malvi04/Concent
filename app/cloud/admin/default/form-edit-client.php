                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="j-wrapper j-wrapper">
                                                             <form enctype="multipart/form-data" name='ac-edit-client' action="ac-edit-client.php" method="post" class="j-pro" id="j-pro">
															    <div class="j-content">
																	<div class="j-row">
																	<div class="j-span4 j-unit">
                                                                        <label class="j-label">Customer ID</label>
                                                                        <div class="j-input">
                                                                            <label class="j-icon-right" for="idcust">
																			<i class="icofont icofont-id-card"></i>
																		</label>
                                                                            <input type="text" id="idcust" name="idcust" value='<?=$idcust?>' readonly>
                                                                        </div>
                                                                    </div>
																	</div>
                                                                    <!-- start name -->
