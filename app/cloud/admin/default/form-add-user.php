											...
											?>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form action="ac-add-user.php" method="post" class="j-pro" id="j-pro">
                                                                <div class="j-content">
                                                                    <!-- start name -->
                                                                    <div>
                                                      ...
                                                      <select id="level" name="level" class="js-example-basic-single col-sm-12" required>
                                                        <option value="" selected>Choose User Level</option>
                                                        <?php
                                                    ...
                                                    <i></i>
                                                            ...
                                                            <i class="icofont icofont-lock"></i>
                                                                ...
                                                                <!-- end /.content -->
                                                                <div class="j-footer">
																<button type="submit" class="btn btn-mat btn-success">Register</button>
