...
<div id="pcoded" class="pcoded">
	...
	$user=$_GET["user"];	
	$Cari="select * from login where user = '$user'";
	...
	?>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form action="ac-edit-user.php" method="post" class="j-pro" id="j-pro">
                                                                <div class="j-content">
                                                                    <!-- start name -->
                                                                    <div>
                                                            ...
                                                            <i class="icofont icofont-ui-user"></i>
                                                                                ...
                                                                                <input value="<?=$nama?>" type="text" id="name" name="name" required>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- end name -->
                                                      ...
                                                      <select id="level" name="level" class="js-example-basic-single col-sm-12" required>
                                                        <option value="<?=$level?>"><?=$level?></option>
                                                        <?php
																	mysql_connect("localhost", "root", "root");
																	mysql_select_db("cardig");
																	$sql = mysql_query("select level from login group by level");
                                                    ...
                                                    <i></i>
                                                            ...
                                                            <i class="icofont icofont-envelope"></i>
                                                                    ...
                                                                    <div>
                                                                        <div>
                                                                            <label class="j-label">Phone Number</label>
                                                                        </div>
                                                                        <div class="j-unit">
                                                                            <div class="j-input">
                                                            ...
                                                            <i class="icofont icofont-ui-check"></i>
                                                                                ...
                                                                                <input value="<?=$user?>" type="text" id="login" name="login" readonly>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- end login -->
                                                            ...
                                                            <i class="icofont icofont-lock"></i>
                                                                ...
                                                                <div class="j-footer">
																	...
																	<button type="cancel" class="btn btn-mat btn-warning m-r-20" onclick="javascript:window.location='list-user.php';">Cancel</button>
                                                                </div>
                                                                <!-- end /.footer -->
                                                            </form>
                                                        </div>
