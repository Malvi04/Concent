...
$query2="UPDATE ticketscategory SET category='$category',personInCharge='$name',phone='$phone',email='$email',copyemail='$copyemail',gmemail='$gmemail',division='$division',dateUpdate='$date',userUpdate='$user'
where id='$id'";
