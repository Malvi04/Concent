...
<div id="pcoded" class="pcoded">
                                ...
                                <!-- Page-header end -->
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>List FAQ</h5>
												<a href="form-add-faq.php"><button class="btn btn-sm btn-success btn-new-tickets waves-effect waves-light m-r-15 m-b-5 m-t-5" style="float: right;"><i class="icofont icofont-user-alt-3"></i>Add FAQ</button></a>
											</div>
	...
	?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?=$dateCreate?></td>
																		<td>
																		<a title="Edit" data-placement="right" class="bbtn btn-sm btn-warning btn-new-tickets waves-effect waves-light m-r-15 m-b-5 m-t-5" data-toggle="modal" href="#myModal3" onclick="set_url3('form-edit-faq.php?id=<?=$id?>');">Edit</a>
																		<a title="Del" data-placement="right" class="bbtn btn-sm btn-danger btn-new-tickets waves-effect waves-light m-r-15 m-b-5 m-t-5" data-toggle="modal" href="#myModal" onclick="set_url('ac-del-faq.php?id=<?=$id?>');">Delete</a>
																		</td>
																	</tr>
																	<?php  
		}
