                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="j-wrapper j-wrapper">
                                                             <form enctype="multipart/form-data" name='ac-edit-pic' action="ac-add-pic.php" method="post" class="j-pro" id="j-pro">
															    <div class="j-content">
																	...
																	<div class="j-span4 j-unit">
                                                                        ...
                                                                        <div class="j-input">
                                                                            ...
                                                                            <input type = "text" list = "category" name="category" required> 
                                                        ...
                                                        <i class="icofont icofont-envelope"></i>
                                                            ...
                                                            <i class="icofont icofont-envelope"></i>
                                                                                ...
                                                                                <input type="email" list="copyemail" name="copyemail" required>
																				<datalist id = "copyemail">
																		<?php
																	$Open2 = mysqli_connect("localhost", "root", "root");
																	$db2 = mysqli_select_db($Open2, "cloudconcent");
																	$sql2 = mysqli_query($Open, "SELECT copyemail FROM ticketscategory");
																	if(mysqli_num_rows($sql2) != 0){
																		while($row2 = mysqli_fetch_assoc($sql2)){
																			echo '<option value="'.$row2['copyemail'].'">'.$row2['copyemail'].'</option>';
																		}
																	}
																	?>
																		</datalist>
                                                            ...
                                                            <i class="icofont icofont-envelope"></i>
                                                                                ...
                                                                                <input type="text" list="gmemail" name="gmemail" required>
																				<datalist id = "gmemail">
																		<?php
																	$Open = mysqli_connect("localhost", "root", "root");
																	$db = mysqli_select_db($Open, "cloudconcent");
																	$sql = mysqli_query($Open, "SELECT gmemail FROM ticketscategory");
																	if(mysqli_num_rows($sql) != 0){
																		while($row = mysqli_fetch_assoc($sql)){
																			echo '<option value="'.$row['gmemail'].'">'.$row['gmemail'].'</option>';
																		}
																	}
																	?>
																		</datalist>
