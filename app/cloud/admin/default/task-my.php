...
<body>
	...
	$user = $_SESSION['nama'];	
	$Cari="select * from activity_log where driver = '$user' AND id_status = 'Request' order by input_date DESC";
	...
	?>
                                                                    <tr>
                                                                        <td><label class="label label-success"><?=$status?></label></td>
																		<td><?=$id?></td>
																		<td><?=$item_name?></td>
																		<td><?=$qty?></td>
                                                                        <td><?=$dest?></td>
                                                                        <td><?=$input_date?></td>
																		<td><div align="center"><a type='button' class='btn btn-success' href="ac-pickup.php?id=<?=$id?>&item=<?=$item_name?>&dest=<?=$dest?>">Pick Up</a></div></td>
                                                                    </tr>
																	<?php  
		}
	}
